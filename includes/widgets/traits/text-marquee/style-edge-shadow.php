...
trait Textmarquee_Style_Edge_shadow {
    protected function style_edge_shadow()
    {
		$this->start_controls_section(
			'deensimc_style_edge_shadow_section',
			[
				'label' => esc_html__( 'Edge Shadow', 'marquee-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
					'deensimc_text_marquee_show_edge_shadow_switch' => 'yes',
				],
			]
		);

		$this->add_control(
			'deensimc_text_marquee_edge_shadow_color',
			[
		...
		$this->add_control(
			"deensimc_text_marquee_edge_shadow_spread",
			[
				'label' => esc_html__('Shadow Size', 'marquee-addons-for-elementor'),
		...
		$this->add_control(
			"deensimc_text_marquee_edge_shadow_blur",
			[
