...
trait Imagemarquee_Style_Edge_Shadow {
    protected function style_edge_shadow()
    {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Edge Shadow',  'marquee-addons-pro-for-elementor' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Color',  'marquee-addons-pro-for-elementor' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Size', 'marquee-addons-pro-for-elementor' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Blur', 'marquee-addons-pro-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem' ],
				'range' => [
					'px' => [
